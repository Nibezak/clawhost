...
import type { NpmRegistryVersionsResponse, NpmDownloadsResponse } from '@/ts/Interfaces'
...
const getClawVersions = async (c: AuthenticatedContext) => {
    try {
        ...
        const registry = (await registryResponse.json()) as NpmRegistryVersionsResponse
