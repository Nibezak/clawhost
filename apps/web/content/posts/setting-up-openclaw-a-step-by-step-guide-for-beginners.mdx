...
# Option C: Use Gemini (requires Google API key from https://makersuite.google.com/app/apikey)
LLM_PROVIDER=google
...
Free tier gives you $5/month in API credits. That's plenty to experiment.
...
Claude API: $5/month free
OpenAI API: First $5 in credits
