...
description: Scale beyond one agent. Learn how to orchestrate multiple OpenClaw instances,
...
- tutorial
- automation
coverImage: /multi-agent-architecture-running-multiple-ai-personalities-in-parallel.webp
---
...
workflow = {
  steps: [
    ...
    { trigger: "parseAgent.done", agent: "responseAgent", action: "generate_response" }
  ]
};
```
