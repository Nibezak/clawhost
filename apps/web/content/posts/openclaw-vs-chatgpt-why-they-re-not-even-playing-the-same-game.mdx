...
**ChatGPT Pro**: $20/month (unlimited conversations)

**ChatGPT API**: $0.15 per million input tokens (variable)
...
**ChatGPT**: Each conversation is separate. Previous conversations don't inform current ones.
