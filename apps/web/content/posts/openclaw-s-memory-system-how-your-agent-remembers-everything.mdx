...
sessionMemory = {
  ...
  strategies: {
    market_research: {
      successful_approach: "Use 3 sources minimum, Gartner data + analyst reports",
...
curration = {
  important: {
    criteria: ["affects multiple decisions", "high stakes", "unique insight"],
...
memory_relevance = {
  ...
  created_6_months_ago: { weight: 0.70 },   // Moderately relevant
  created_1_year_ago: { weight: 0.50 }      // Background info
};
