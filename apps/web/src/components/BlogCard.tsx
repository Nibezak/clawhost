  ...
  return (
    ...
    >
      <div className="aspect-[16/9] w-full overflow-hidden bg-white/5">
        {post.coverImage ? (
          ...
          <div className="flex h-full items-center justify-center">
            <span className="font-clash text-2xl font-bold text-white/10">ClawHost</span>
          </div>
        )}
      </div>
      ...
      <div className="p-5">
        ...
        <h2 className="font-clash mb-2 text-lg font-semibold text-white transition group-hover:text-primary">
          {post.title}
        </h2>
