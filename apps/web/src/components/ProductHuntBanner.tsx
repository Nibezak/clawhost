                        ...
                        <div className='relative px-4 pb-2 pt-3 text-center text-sm leading-6'>
                            <p className='inline'>
                                <span className='mb-[3px] inline-flex items-center gap-2 align-middle'>
                                    <span className='hidden text-foreground/50 sm:inline'>{t('productHunt.liveOn')}</span>
                                ...
                                <span className='hidden text-foreground/60 sm:inline'>{t('productHunt.celebrate')} </span>
                                <span className='text-foreground/60 sm:font-bold sm:text-[#ff6154]'> {t('productHunt.discount')}</span>
                                <span className='hidden text-foreground/60 sm:inline'> {t('productHunt.yourFirstMonth')}.</span>
                            </p>
                            <a
                                href={PRODUCT_HUNT_URL}
                                target='_blank'
                                rel='noopener noreferrer'
                                className='ml-3 inline-flex items-center gap-1.5 rounded-md bg-[#ff6154] px-3 py-1 mb-1 align-middle text-xs font-semibold text-white transition-all hover:bg-[#ff6154]/90 hover:shadow-[0_0_12px_rgba(255,97,84,0.4)]'
                            >
                            ...
                            <button
                                ...
                                className='absolute right-4 top-1/2 -translate-y-1/2 text-foreground/30 transition hover:text-foreground/60'
