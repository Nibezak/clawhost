      ...
      >
        ...
        <div className="mb-8 flex items-center gap-4 text-sm text-gray-400">
          ...
          <span className="flex items-center gap-1.5">
            ...
            {t('blog.readingTime', { minutes: String(meta.readingTime) })}
          </span>
        </div>
        ...
        <div className="prose prose-invert prose-sm max-w-none prose-headings:font-clash prose-headings:font-semibold prose-h1:hidden prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
          <Content />
        </div>
      </motion.main>
