...
const Account: FC = (): ReactNode => {
  ...
  const getBillingReasonLabel = (reason: string) => {
    switch (reason) {
      case 'purchase': return t('account.billingReasonPurchase')
      case 'subscription_create': return t('account.billingReasonSubscriptionCreate')
      case 'subscription_cycle': return t('account.billingReasonSubscriptionCycle')
      case 'subscription_update': return t('account.billingReasonSubscriptionUpdate')
    ...
    <div className="relative flex min-h-screen flex-col bg-[#0a0a0f] text-white">
      ...
      >
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
          <h3 className="mb-1 font-semibold">{t('account.profileInformation')}</h3>
          <p className="text-muted-foreground mb-6 text-sm">{t('account.profileDescription')}</p>
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="text-muted-foreground flex items-center gap-6 text-sm">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span>{userStats?.clawCount ?? 0} {t('account.claws')}</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Key className="h-4 w-4" />
                  <span>{userStats?.sshKeyCount ?? 0} {t('account.sshKeys')}</span>
                </div>
              </div>
            </div>
          </div>
