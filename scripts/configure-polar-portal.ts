...
if (!POLAR_ACCESS_TOKEN || !POLAR_ORGANIZATION_ID) {
    console.error(
        'Missing POLAR_ACCESS_TOKEN or POLAR_ORGANIZATION_ID in apps/api/.env'
    )
    process.exit(1)
}
...
async function configurePortal() {
    ...
    console.log(
        'Current customer_portal_settings:',
        JSON.stringify(org.customer_portal_settings, null, 2)
    )
    console.log(
        'Current subscription_settings:',
        JSON.stringify(org.subscription_settings, null, 2)
    )
    console.log()
    ...
    console.log(
        'Updated customer_portal_settings:',
        JSON.stringify(updated.customer_portal_settings, null, 2)
    )
    console.log(
        'Updated subscription_settings:',
        JSON.stringify(updated.subscription_settings, null, 2)
    )
    console.log(
