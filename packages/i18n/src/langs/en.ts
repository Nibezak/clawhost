export const en = {
  ...
  errors: {
    ...
    failedToGenerateKeyPair: 'Failed to generate key pair. Please generate keys locally instead.',
  ...
  auth: {
    ...
    clickLinkToSignIn: 'Click the link in the email to sign in. You can close this tab.',
    signInToDeployOpenClaw: 'Sign in to deploy OpenClaw',
    emailAddress: 'Email address',
    emailPlaceholder: 'you@example.com',
    continueWithEmail: 'Continue with Email',
    sending: 'Sending...',
    magicLinkDescription: "We'll send you a magic link to sign in. No password needed.",
  ...
  dashboard: {
    title: 'Claws',
    yourClaws: 'Your Claws',
    claw: 'claw',
    clawsPlural: 'claws',
    newClaw: 'New Claw',
    noClawsYet: 'No Claws yet',
    noClawsDescription: 'Deploy OpenClaw on your first VPS and start browsing securely',
  ...
  createClaw: {
    ...
    autoGeneratePasswordHint: 'Leave empty to auto-generate a secure password',
  ...
  sshKeys: {
    ...
    noSshKeysDescription: 'Add an SSH key to enable passwordless login to your instances',
    ...
    addSshKeyModalDescription: 'Add an SSH key for passwordless authentication',
    ...
    thenSwitchToIHave: 'Then switch to "I have an SSH key" and paste the public key.',
    savePrivateKeyNow:
  ...
  landing: {
    badge: 'Deploy OpenClaw on your own VPS',
    ...
    locations: 'Locations',
    yourData: 'Your Data',
    dashboardPreviewTitle: 'Your Claws',
    dashboardPreviewSubtitle: '2 OpenClaw claws running',
    deployNew: 'Deploy New',
    running: 'Running',
    latency: 'latency',
    howItWorks: 'How it works',
    threeStepsToPrivacy: 'Three steps to privacy',
    howItWorksDescription: 'From zero to fully encrypted connection in under a minute',
    ...
    step3Title: 'Connect & go',
    step3Description:
      "Download your config, import into any WireGuard client, and you're protected.",
    features: 'Features',
    ...
    truePrivacy: 'True Privacy',
    truePrivacyDescription:
    ...
    fullSshAccessDescription: 'Root access to your VPS. Install anything, customize everything.',
    wireGuardBuiltIn: 'WireGuard Built-in',
    wireGuardBuiltInDescription: 'OpenClaw uses WireGuard — modern, fast, and secure by default.',
    testimonials: 'Testimonials',
    whatPeopleSay: 'What people say',
    testimonialsDescription: "Join thousands who've taken control of their privacy",
    testimonial1Quote:
    ...
    pricingDescription: 'Pay only for what you use. All plans include OpenClaw pre-installed',
    planColumn: 'Plan',
    vCpuColumn: 'vCPU',
    ramColumn: 'RAM',
