const en = {
    ...
    api: {
        ...
        whatsappUnsupported: 'This instance does not support WhatsApp pairing yet.',
    ...
    playground: {
        ...
        addAgentApiKeyConfigured: '{{envVar}} already set. Edit in Variables tab after adding.',
        ...
        channelsWhatsAppScanQr: 'Scan this QR code with WhatsApp to link your device.',
        channelsWhatsAppScanInstructions: 'Open WhatsApp > Settings > Linked Devices > Link a Device',
        ...
        channelsWhatsAppUnsupported: 'WhatsApp pairing is not available on this instance. Update OpenClaw to a newer version to enable it.',
