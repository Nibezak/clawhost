...
const de: Translations = {
    ...
    dashboard: {
        ...
        noClawsDescription:
            'Kein bereitgestellter Claw gefunden. Aber du kannst jederzeit deinen ersten Claw ab 10 $/Monat bereitstellen. Einfach per KI.',
        ...
        scrollToBottom: 'Zu neuen Logs scrollen',
    ...
    landing: {
        ...
        fullSshAccess: 'Voller SSH-Zugriff',
        fullSshAccessDescription:
            'Voller Root-Zugriff auf deinen Server. Er gehört dir – installiere alles und passe alles an.',
        secure: 'Sicher',
        secureDescription:
        ...
        autoUpdatesDescription:
            'Vergiss Updates und Sicherheitspatches. Der Server und OpenClaw werden automatisch aktuell gehalten.',
    ...
    playground: {
        ...
        tabChannels: 'Kanäle',
        channelsDescription:
            'Konfiguriere Messaging-Kanäle für diese Instanz. Kanäle werden von allen Agenten geteilt.',
